...
class ControllerPaymentPaytabs extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/paytabs', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['paytabs_merchant'])) {
			...
			$this->data['paytabs_merchant'] = $this->config->get('paytabs_merchant');
		}

		if (isset($this->request->post['paytabs_security'])) {
			$this->data['paytabs_security'] = $this->request->post['paytabs_security'];
		} else {
			$this->data['paytabs_security'] = $this->config->get('paytabs_security');
		}

		$this->data['callback'] = HTTP_CATALOG . 'index.php?route=payment/paytabs/callback';

		if (isset($this->request->post['paytabs_total'])) {
			$this->data['paytabs_total'] = $this->request->post['paytabs_total'];
		} else {
			$this->data['paytabs_total'] = $this->config->get('paytabs_total'); 
		} 

		if (isset($this->request->post['paytabs_order_status_id'])) {
			$this->data['paytabs_order_status_id'] = $this->request->post['paytabs_order_status_id'];
		} else {
			$this->data['paytabs_order_status_id'] = $this->config->get('paytabs_order_status_id'); 
		} 
		...
		if (isset($this->request->post['paytabs_geo_zone_id'])) {
			$this->data['paytabs_geo_zone_id'] = $this->request->post['paytabs_geo_zone_id'];
		} else {
			$this->data['paytabs_geo_zone_id'] = $this->config->get('paytabs_geo_zone_id'); 
		} 
		...
		if (isset($this->request->post['paytabs_status'])) {
			$this->data['paytabs_status'] = $this->request->post['paytabs_status'];
		} else {
			$this->data['paytabs_status'] = $this->config->get('paytabs_status');
		}

		if (isset($this->request->post['paytabs_sort_order'])) {
			$this->data['paytabs_sort_order'] = $this->request->post['paytabs_sort_order'];
		} else {
			$this->data['paytabs_sort_order'] = $this->config->get('paytabs_sort_order');
		}
